...
export async function uploadTermoConsentimento({ pacienteNome, dataAssinatura, telefone, objetivos, expectativas, signatureDataUrl }) {
  ...
  if (res.status === 401) { _accessToken = null; _tokenExpiry = 0; return uploadTermoConsentimento({ pacienteNome, dataAssinatura, telefone, objetivos, expectativas, signatureDataUrl }); }
